...
public class ItemBean {
    ...
    public static List<ItemBean> getList(){
        ...
        String product_name[]={
                "饱腹代餐粥","低脂牛肉棒","番茄340g","精选鲜鸡蛋10枚",
                "麦维他消化饼干 250g","河源山地鸡500g","天农鸡胸肉400g"
        };
        int ImgId[]={
          R.drawable.full_porridge,R.drawable.beef_stick,R.drawable.tomato,
                R.drawable.egg,R.drawable.biscuit,R.drawable.chicken,R.drawable.chicken_breast
        };
        String Product_Price[]={
                "￥59.9/盒","￥39.9/5条","￥4.5/份","￥11.8/盒",
                "￥13.5/袋","￥23.8/盒","￥14.9/盒"
        };
